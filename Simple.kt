...
fun accountInThreeYears(initial: Int, percent: Int): Double {
    val firstYear = (initial * percent / 100).toDouble()
    val secondYear = (initial + firstYear) * percent / 100
    val thirdYear = (initial + firstYear + secondYear) * percent / 100
    return initial + firstYear + secondYear + thirdYear
}
